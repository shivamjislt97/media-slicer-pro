...
MEGA_CMD = None
for path in [
    r'C:\Users\Administrator\AppData\Local\MEGAcmd\MEGAclient.exe',
...
if MEGA_CMD:
    ...
    if result.returncode == 0:
        ...
        print('[MEGA] Not logged in - upload will be skipped')
        MEGA_CMD = None
else:
    print('[MEGA] MEGAcmd not found - skipping upload')
